...
def get_current_sky():
    ...
    try:
        ...
        for name, code, cat in [
            ...
            ("Giove", swe.JUPITER, "lento"), ("Saturno", swe.SATURN, "lento"), 
            ("Urano", swe.URANUS, "lento"), ("Nettuno", swe.NEPTUNE, "lento"), ("Plutone", swe.PLUTO, "lento"),
        ...
        for name, swe_const, iau_num in [
            ("Cerere", getattr(swe, 'CERES', None), 1), ("Pallade", getattr(swe, 'PALLAS', None), 2), 
            ("Giunone", getattr(swe, 'JUNO', None), 3), ("Vesta", getattr(swe, 'VESTA', None), 4)
        ]:
        ...
        VISIBILITY_LOOKUP = {
            ...
            "2026-03-03": "Pacifico, Australia, Americhe", "2026-08-28": "Europa, Africa, America",
            "2027-02-21": "Americhe, Europa, Africa", "2027-07-18": "Oceano Indiano, Africa", "2027-08-17": "Pacifico, Sud America",
        }
