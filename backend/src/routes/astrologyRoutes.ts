...
import { 
  ...
  getPendingCharts, approveChart, getLatestHoroscope, calculatePaidHoroscope, approveHoroscope,
...
router.post('/generate-horoscope', requireClerkAuth, calculatePaidHoroscope)
