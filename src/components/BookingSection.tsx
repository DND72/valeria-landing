      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {isLoaded && (
          ...
          >
            ...
            <p className="text-white/20 text-[10px] mt-6 text-center max-w-xs mx-auto leading-relaxed">
              Registrandoti o prenotando un consulto dichiari di avere almeno 18 anni e di accettare i{' '}
