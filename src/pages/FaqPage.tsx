    ...
    items: [
      {
        ...
        a: "Puoi registrarti gratuitamente, accedere al tuo Diario privato, scegliere il tipo di consulto con Valeria (tarocchi, coaching o percorsi combo), prenotare tramite Calendly e ricevere il link di accesso alla sessione. Hai anche a disposizione 7 minuti di consulto omaggio per il tuo primo incontro.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Nel tuo Diario (dopo il login) scegli il settore (Tarocchi, Coaching o Combo), poi il tipo di consulto preferito. Clicca Continua e si apre il widget Calendly dove selezioni giorno e fascia oraria disponibile. Per i consulti a pagamento, completi il pagamento tramite PayPal su Calendly.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Il pagamento avviene tramite PayPal al momento della prenotazione su Calendly. Non e necessario avere un conto PayPal: puoi pagare anche con carta di credito/debito tramite il modulo sicuro di PayPal.",
      },
      {
        q: 'I miei dati di pagamento sono al sicuro?',
        a: "Si. Il pagamento e gestito interamente da PayPal, che non condivide i dati della carta con il sito. Valeria Di Pace non archivia alcun dato di pagamento.",
      },
      {
        q: 'Posso chiedere un rimborso?',
        a: "Se cancelli con almeno 24 ore di anticipo tramite il link in email, il rimborso viene elaborato tramite PayPal secondo le tempistiche standard (3-5 giorni lavorativi). Cancellazioni sotto le 24 ore non sono rimborsabili. Per situazioni straordinarie, puoi scrivere direttamente a Valeria tramite i contatti in fondo alla pagina.",
      },
      {
        q: "Ricevero una fattura o ricevuta?",
        a: "PayPal invia automaticamente la conferma di pagamento via email. Se hai bisogno di documentazione fiscale, puoi richiederla a Valeria indicando i tuoi dati di fatturazione.",
      },
    ],
  },
  {
